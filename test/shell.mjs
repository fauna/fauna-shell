...
import { isQueryable as originalIsQueryable } from "../src/lib/fauna-client.mjs";
...
describe("shell", function () {
  let container, stdin, stdout, stderr, logger, faunaClient, runQueryFromString;
  ...
  beforeEach(() => {
    ...
    faunaClient = container.resolve("faunaClient");
  ...
  describe("common", function () {
    ...
    it("can fail before getting to shell if the database is not queryable", async function () {
      faunaClient.isQueryable.rejects(
        new ValidationError("Database not found: us/bad"),
      );
    ...
    it("can handle network errors", async function () {
      ...
      faunaClient.isQueryable = originalIsQueryable;
